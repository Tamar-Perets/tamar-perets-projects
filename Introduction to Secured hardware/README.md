...
* **Description:** Recovering a secret cryptographic key from hardware FPGA power traces ($SBOX(p \oplus k)$) using CPA across Hamming Weight, Hamming Distance, and Value models.
